          ...
          <div className="bg-card rounded-3xl pt-8 md:pt-12 px-6 md:px-12 pb-6 md:pb-8 transition-smooth md:hover:scale-105 cursor-pointer overflow-hidden max-w-5xl mx-auto">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 mb-8">
              <div className="md:flex-shrink-0">
                <div className="relative">
                  ...
                  <div className="relative w-44 h-52 md:w-56 md:h-64 hover-scale group">
                    ...
                    <img 
                      src="/lovable-uploads/e1ed53a4-556d-4c20-be9c-eebe38ff3f8a.png" 
                      alt="Marco Krebs drinking coffee" 
                      loading="lazy" 
                      className="relative z-10 w-full h-full object-cover object-center shadow-lg group-hover:shadow-2xl transition-shadow duration-300"
                      style={{ clipPath: "url(#torn-edge)" }}
                    />
              ...
              <div className="space-y-6 text-base md:text-lg text-muted-foreground leading-relaxed text-center md:text-left md:flex-1 mt-6 md:mt-0">
                <p className="text-justify">I'm an entrepreneur and strategic advisor with a track record of building and scaling AI-driven startups. I began in management consulting, guiding enterprises through digital transformation. Later, I moved into innovation leadership in global organizations. Over the past decade, I co-founded one AI venture and helped scale another, leading fundraising, product strategy, and achieving a successful exit. Today, I help startups and established companies shape strategy, drive digital innovation and scale growth by navigating complex markets and leveraging new technologies.</p>
              </div>
            </div>
            ...
            <div className="mt-3 pt-3 border-t border-border/20">
              <div className="flex items-start gap-6 md:gap-8">
                <div className="hidden md:block md:flex-shrink-0 md:w-[calc(14rem+1.5rem)]"></div>
                <div className="flex flex-wrap gap-6 md:gap-0 items-center justify-center md:justify-between flex-1">
                  <img src="/lovable-uploads/6da2db52-bf35-46ae-8154-e9f6b2fa4e94.png" alt="Deutsche Telekom" loading="lazy" className="h-6 w-auto object-contain opacity-40 hover:opacity-60 transition-smooth grayscale" />
                  ...
                  <img src="/lovable-uploads/19117524-8b19-457a-87c7-7e8d0429528b.png" alt="Laya" loading="lazy" className="h-3 md:h-2.5 w-auto object-contain opacity-40 hover:opacity-60 transition-smooth grayscale" />
                </div>
              </div>
            </div>
          </div>
